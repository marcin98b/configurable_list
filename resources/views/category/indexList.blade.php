<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Konfiguracja kategorii (dla listy: "{{$list->name}}")
    ...
    <div class="py-8">
        ...
        <div class="max-w-7xl mx-auto sm:px-8 lg:px-8">
            ...
            <div class="pb-5 flex justify-end">
                <form method="POST" action="{{route('list_categoryCreate', $list->id)}}">
                @csrf 
          ...
          <div class="container max-w-7xl mx-auto ">
                ...
                @foreach ($listCategories as $listCategory)
                    ...
                    <div id="{{$listCategory->id}}" class="draggable" draggable="true">
                        <div class="clearfix h-24 p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="float-right">
                            ...
                            <form style="margin:0px; padding:0px; display:inline;" action="{{route('list_categoryDelete', [$list->id, $listCategory->id])}}" method="POST">
                                @csrf
                                @method('DELETE')
...
function getOrder() {
    ...
    if(!arr.length) window.location("/lists/"+{{$list->id}}+"/categories/");
    //POST
    var url = "/lists/"+{{$list->id}}+"/categories/updatePosition/"+arr.toString();
